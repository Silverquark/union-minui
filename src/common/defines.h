...
#define FAUX_RECENT_PATH SDCARD_PATH "/Weiter spielen"
#define FAVORITE_PATH USERDATA_PATH "/.minui/favorite.txt"
#define FAUX_FAVORITE_PATH SDCARD_PATH "/Favoriten"
#define COLLECTIONS_PATH SDCARD_PATH "/Sammlungen"
